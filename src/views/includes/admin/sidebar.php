<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo sidebar-active">
            <a href="<?= Route('home'); ?>">
                <img src="/src/assets/images/aflogo-sm.png" alt="" />
                <p>BakeryKho</p>
            </a>
        </div>
        <div>
    ...
    <div class="sidebar-content">
        <ul class="sidebar-content-list">
            <li class="">
                <a href="<?= Route('dashboard'); ?>"> <i class="icon bi bi-people"></i><span class="sidebar-active sidebar-title">Dashboard</span> </a>
            </li>
        </ul>
